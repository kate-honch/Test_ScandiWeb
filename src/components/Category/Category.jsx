...
import file2 from '../../images/002.png';
import file3 from '../../images/003.png';
import file4 from '../../images/004.png';
import file5 from '../../images/005.png';
import file6 from '../../images/006.png';
...
import { CheckOutPage } from "../CheckOutPage/CheckOutPage";
  ...
  export class Category extends React.Component {
    constructor({quantityProducts ,shownProductPage, shownCartPage,changeAddNumCard}) {
      super({quantityProducts ,shownProductPage, shownCartPage,changeAddNumCard});
    }

    addNumCard = () => {
      this.props.changeAddNumCard(this.props.quantityProducts + 1);
    }


  
    render() {
      const {shownProductPage, shownCartPage } = this.props;
      return (
        <>
          {
            shownProductPage ?
            ...
            <div className="category">
              ...
              <div className="category__container">
                {
                    productCard.map((el) => (
                      <div className="category__product-card" key={el.id}>
                        <img src={el.img} alt="product"/>

                        <h3 className="category__text">{el.title}</h3>

                        <p className="category__price" >{el.price}</p>

                        <button className="category__btn" onClick={this.addNumCard}>
